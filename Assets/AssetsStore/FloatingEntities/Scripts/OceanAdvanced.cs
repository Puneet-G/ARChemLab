...
public class OceanAdvanced : MonoBehaviour
{
  ...
  static Wave[] waves =
  {
    new Wave(9.9f, 1.0f, 0.014f, 0.9f, new Vector2(1.0f,  0.2f)),
    new Wave(6, 1.2f, 0.08f, 0.5f, new Vector2(1.0f,  3.0f)),
    new Wave(2, 3.5f, 0.04f, 0.8f, new Vector2(2.0f,  4.0f)),
    new Wave(3, 2.0f, 0.04f, 0.4f, new Vector2(-1.0f, 0.0f)),
    new Wave(1, 3.0f, 0.005f, 0.9f,new Vector2(-1.0f, 1.2f))
  };
